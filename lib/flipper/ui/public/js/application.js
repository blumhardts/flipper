...
function initializeExpression() {
  ...
  document.addEventListener("change", function (e) {
    ...
    if (e.target.classList.contains("js-change-property-expression-operator")) {
      var expression = e.target.closest(".property-expression");
      var propertyControl = expression.querySelector(".expression-property-control select")
      var valueControl = expression.querySelector(".expression-value-control input, select");

      e.target.name = "expression[" + e.target.value + "]";
      propertyControl.name = "expression[" + e.target.value + "][][Property][]";
      valueControl.name = "expression[" + e.target.value + "][][]";
    }
  });
}
